...
var BANNER = '\u001B[96mThanks for using Plot! See the README for help and to support the developer: \u001B[94m https://github.com/data-forge-notebook/plot \u001B[96m\u001B[0m\n\n';

function isBannerRequired() {
  if (ADBLOCK || CI || DISABLE_OPENCOLLECTIVE || SILENT) return false;
  var file = path.join(os.tmpdir(), 'plot-banners');
  var banners = [];
  try {
