...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/template.ts");
/******/ })
/************************************************************************/
/******/ ({

/***/ "../node_modules/@plotex/lib-apex/build/index.js":
/*!*******************************************************!*\
  !*** ../node_modules/@plotex/lib-apex/build/index.js ***!
  \*******************************************************/
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.mountChart = exports.formatChartDef = void 0;
var format_chart_def_1 = __webpack_require__(/*! ./lib/format-chart-def */ "../node_modules/@plotex/lib-apex/build/lib/format-chart-def.js");
var format_chart_def_2 = __webpack_require__(/*! ./lib/format-chart-def */ "../node_modules/@plotex/lib-apex/build/lib/format-chart-def.js");
Object.defineProperty(exports, "formatChartDef", { enumerable: true, get: function () { return format_chart_def_2.formatChartDef; } });
var ApexCharts = __webpack_require__(/*! apexcharts */ "../node_modules/apexcharts/dist/apexcharts.common.js");
...
/***/ "../node_modules/@plotex/lib-apex/build/lib/format-chart-def.js":
/*!**********************************************************************!*\
  !*** ../node_modules/@plotex/lib-apex/build/lib/format-chart-def.js ***!
  \**********************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.formatChartDef = void 0;
var dayjs = __webpack_require__(/*! dayjs */ "../node_modules/dayjs/dayjs.min.js");
var numeral = __webpack_require__(/*! numeral */ "../node_modules/numeral/numeral.js");
//
// Build a series for Apex charts.
//
function buildApexSeries(seriesName, data, xAxisValues) {
    if (!seriesName || !data || !data.series || !data.series[seriesName] || !data.series[seriesName].values) {
        return [];
    }
    return data.series[seriesName].values
        .map(function (yValue, index) { return ({ x: xAxisValues && xAxisValues[index] || index, y: yValue }); });
}
//
// Extract series from the chart definition's data.
//
function extractSeries(chartDef, axises, xAxis) {
    return axises.map(function (axisConfig) {
        var _a;
        var xAxisColumnName = ((_a = axisConfig.x) === null || _a === void 0 ? void 0 : _a.series) || xAxis && xAxis.series;
        var xAxisValues = xAxisColumnName && chartDef.data.series[xAxisColumnName].values || [];
        var seriesConfig = chartDef.plotConfig.series && chartDef.plotConfig.series[axisConfig.series];
        return {
            name: axisConfig.series,
            type: seriesConfig === null || seriesConfig === void 0 ? void 0 : seriesConfig.chartType,
...
function extractYAxisConfiguration(seriesConfigs, axisConfig, opposite, data) {
    ...
    return seriesConfigs.map(function (seriesConfig) {
        ...
        var dataType = data && data.series && data.series[columnName] && data.series[columnName].type;
        if (formatString) {
            if (dataType === "date") {
...
//
function extractAnnotation(annotations, annotationsField, yAxisIndex, value1Field, value2Field, inputChartDef, annotation) {
    if (!annotation) {
        return;
    }
    var styleName = annotation.style || "default";
    var annotationStyle = inputChartDef.plotConfig.annotations && inputChartDef.plotConfig.annotations[styleName] || {};
    var apexAnnotation = {
        label: {
            style: {},
        },
    ...
    annotations[annotationsField].push(apexAnnotation);
}
//
// Extracts annotations from a series.
//
function extractAnnotationsFromSeries(annotations, annotationsField, yAxisIndex, value1Field, value2Field, inputChartDef, axisSeriesConfig) {
    if (axisSeriesConfig) {
        var series = inputChartDef.data.series[axisSeriesConfig.series];
        if (series) {
            if (series.annotations) {
                for (var _i = 0, _a = series.annotations; _i < _a.length; _i++) {
...
//
function extractAnnotationsFromSeriesArray(annotations, annotationsField, yAxisIndex, value1Field, value2Field, inputChartDef, seriesConfigs) {
    for (var _i = 0, seriesConfigs_1 = seriesConfigs; _i < seriesConfigs_1.length; _i++) {
        var axisSeriesConfig = seriesConfigs_1[_i];
...
//
function extractAnnotations(inputChartDef) {
    var annotations = {
        yaxis: [],
        xaxis: [],
    };
...
function formatChartDef(inputChartDef) {
    ...
    var xAxisFormatString = inputChartDef && inputChartDef.plotConfig && inputChartDef.plotConfig.x && inputChartDef.plotConfig.x.format;
    ...
    var yAxisSeries = extractSeries(inputChartDef, inputChartDef.axisMap.y, inputChartDef.axisMap.x)
    ...
    var annotations = extractAnnotations(inputChartDef);
    ...
    var apexTitle;
    if ((_a = inputChartDef === null || inputChartDef === void 0 ? void 0 : inputChartDef.plotConfig) === null || _a === void 0 ? void 0 : _a.title) {
        var inputTitle = inputChartDef.plotConfig.title;
        apexTitle = {
...
//# sourceMappingURL=format-chart-def.js.map
...
Object.defineProperty(exports, "__esModule", { value: true });
var lib_apex_1 = __webpack_require__(/*! @plotex/lib-apex */ "../node_modules/@plotex/lib-apex/build/index.js");
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var response, chartData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("chart-def.json")];
                case 1:
                    response = _a.sent();
                    return [4 /*yield*/, response.json()];
                case 2:
                    chartData = _a.sent();
                    return [4 /*yield*/, lib_apex_1.mountChart(chartData.chartDef, document.getElementById("chart"), chartData.options)];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
