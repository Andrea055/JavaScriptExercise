...
var WebPageRenderer = /** @class */ (function () {
    ...
    WebPageRenderer.prototype.start = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var nightmareOptions, nightmareModulePath, Nightmare;
            return __generator(this, function (_a) {
                ...
                nightmareModulePath = (this.options && this.options.nightmarePath) || "nightmare";
                Nightmare = require(nightmareModulePath);
                ...
                this.nightmare.on('page', function (type, message, stack) {
                    if (type === "error") {
                        _this.error("Browser page error: " + JSON.stringify(message, null, 4));
                        _this.error(stack);
                    }
                });
                ...
                this.nightmare.on('console', function (type, message) {
                    if (type === 'log') {
                        _this.info('LOG: ' + JSON.stringify(message, null, 4));
                        return;
                    }
                    if (type === 'warn') {
                        _this.warn('LOG: ' + JSON.stringify(message, null, 4));
                        return;
                    }
                    if (type === 'error') {
                        _this.error("Browser JavaScript error: " + JSON.stringify(message, null, 4));
                    }
                });
                return [2 /*return*/];
            });
